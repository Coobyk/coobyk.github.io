    ...
    <>
      ...
      <body className="bg-color-background text-color-text">
        ...
        <main className="p-8 justify-center align-center flex flex-col gap-5">
          ...
          {/* Wall of Honor */}
          <section className="mt-8 self-center max-w-[66%] bg-color-secondary bg-opacity-10 rounded-3xl p-7">
            <h1 className="text-3xl font-bold font-mono text-color-primary">Wall of Honor</h1>
          ...
          {/* Portfolio */}
          <section id="portfolio" className="mt-8 self-center max-w-[66%] bg-opacity-10 bg-color-secondary rounded-3xl p-7">
          ...
          {/* Projects */}
          <section id="projects" className="mt-8 self-center max-w-[66%] bg-opacity-10 bg-color-secondary rounded-3xl p-7">
